    ...
    <>
      <div className="tn_sid_bar_totset">
        <div className="tn_right_sid_bar">
          <i
            onClick={handleSlide}
            className="fab fa-bitcoin tn_right_sid_bar_i"
            id="chatSlide"
            data-navn="t1"
          ></i>
          <i
            onClick={handleSlide}
            className="fas fa-volume tn_right_sid_bar_i"
            id="liqutation"
            data-navn="t2"
          ></i>
          <i
            onClick={handleSlide}
            className="fas fa-presentation-screen tn_right_sid_bar_i"
            id="token"
            data-navn="t3"
          ></i>
          <i
            onClick={handleSlide}
            className="fas fa-chart-line-up tn_right_sid_bar_i"
            id="trad"
            data-navn="t4"
          ></i>
          <i
            onClick={handleSlide}
            className="fas fa-droplet tn_right_sid_bar_i"
            id="drop"
            data-navn="t5"
          ></i>
          <i
            onClick={handleSlide}
            className="fas fa-messages-question tn_right_sid_bar_i"
            id="topGL"
            data-navn="t6"
          ></i>
        </div>
